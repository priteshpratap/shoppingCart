sap.ui.define([
	...
	return BaseController.extend("Kiranabajaar.controller.Welcome", {
		...
		onInit: function () {
			var oViewModel = new JSONModel({
				welcomeCarouselShipping: 'ShoppingCart/img/RiceEdited.jpg',
				welcomeCarouselInviteFriend: 'ShoppingCart/img/Atta.jpg',
				welcomeCarouselTablet: 'ShoppingCart/img/Daal.jpg',
				welcomeCarouselCreditCard: 'ShoppingCart/img/Vegetable.jpg',
				brandLogo:'ShoppingCart/img/kiranaKing.jpg',
				Promoted: [],
				Viewed: [],
				Favorite: [],
				Currency: "INR"
